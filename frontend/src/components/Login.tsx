    ...
    <section>
      <div className="box-border w-screen h-screen bg-center bg-no-repeat bg-contain font-anybody bg-img-login">
        <div className="absolute top-0 bottom-0 left-0 right-0 bg-shade-bg">
          <div className="relative flex flex-col w-screen text-center -translate-x-1/2 -translate-y-1/2 sm:w-550 top-1/2 left-1/2">
            ...
            >
              ...
              <div className="flex flex-row justify-center gap-10 mt-8 text-center align-bottom">
                ...
                <Link
                  to="/register"
                  className="text-lg font-bold tracking-wider transition-transform duration-300 ease-in-out hover:scale-110"
                >
                  Registrate
                </Link>
              </div>
          ...
          >
            <FaArrowRight className="my-0.5" />
            <button className="text-xl w-max sm:text-base">
              VOLVER AL INICIO
            </button>
          </Link>
        </div>
