        ...
        >
            <section className='flex gap-20 mx-auto pt-60 s:pt-28 s:m-0'>
                <div className="flex flex-col mb-10">
                    <h1 className='pt-32 text-5xl font-semibold tracking-widest text-center uppercase w-350 s:text-xl s:pt-24 s:w-60 md:w-80 md:text-4xl md:pt-48 lg:text-4xl lg:w-650'>¿Quiénes somos?</h1>
                    <img src="./src/assets/flower.svg" alt="flower" className='mt-auto h-350 -ml-28 -mb-14 lg:mr-auto lg:ml-0 s:h-250' />
                </div>
            </section>
            <section className="flex flex-col mx-auto gap-7 center">
                <article className='flex flex-col h-auto gap-4 my-auto text-xl font-light text-justify w-450 s:text-xs s:w-60 s:gap-0 s: md:text-sm md:w-72 md:gap-2 lg:w-550 lg:text-2xl lg:h-auto'>
