        ...
        >
            <section className='flex gap-20 pt-60 mx-auto s:pt-28 s:m-0'>
                <div className="flex flex-col mb-10">
                    <h1 className='font-semibold text-5xl tracking-widest w-350 text-center pt-32 s:text-xl s:pt-24 s:w-60 md:w-80 md:text-5xl md:pt-72 lg:text-4xl lg:w-650 uppercase'>¿Quiénes somos?</h1>
            ...
            <section className="flex flex-col gap-7 mx-auto center">
                <article className='font-light text-xl w-450 h-auto flex flex-col text-justify gap-4 my-auto s:text-xs s:w-60 s:gap-0 s: md:text-xl md:w-96 md:gap-4 lg:w-550 lg:text-2xl lg:h-auto'>
