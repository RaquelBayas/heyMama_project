...
function ProfileSetting() {
  ...
  return (
    <div className="flex flex-col gap-5 text-xl ">
      <h1 className="mt-10 mb-4 text-4xl tracking-wider text-center uppercase lg:text-start lg:ml-10">
        Ajustes
      </h1>
        ...
        <div className="flex flex-col gap-3 mx-auto max-w-[4-rem]">
          <label htmlFor="avatar">
            ...
            <input
              ...
              accept="image/*"
              name="avatar"
              className="cursor-pointer file:rounded-full file:px-4 file:py-2 file:bg-slate-200 hover:file:cursor-pointer hover:file:bg-slate-400 file:font-bold file:m-4 file:border-0 text-md"
            />
          </label>
        </div>
