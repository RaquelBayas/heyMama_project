...
function ForumHome(): ReactNode {
    ...
    return (
        <Forum>
            ...
            <ForumCard img='./src/assets/foro-info.svg' alt='Una bombilla' bg='orange-100' title='Información' text='Encuentra información más ampliada de parte de profesionales.' page='/articles' />
        </Forum>
    )
}
